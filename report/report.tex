...
\icmltitlerunning{Parallel Gradient Descent for Multilayer Neural Networks}
...
\twocolumn[
\icmltitle{Parallel Gradient Descent for Multilayer Neural Networks}
...
\icmlkeywords{machine learning, neural network, backpropagation, gradient descent, parallel backpropagation, BLAS, Theano}
...
Neural networks can have millions of parameters and learning the optimum value of all parameters from huge datasets can be very time consuming, if implemented on a single processor.
...
We perform our tests on two benchmark datasets: MNIST and KDD Cup 1999, and finally compare all our implementations with the corresponding implementations in the state-of-the-art deep learning library: Theano.
