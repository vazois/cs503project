...
\begin{algorithm}[tb]
   ...
   \label{alg:BackProp}
\begin{algorithmic}
   \STATE {\bfseries Input:} Example $x$, label $y$, parameters $[W_{\{1:L\}}, b_{\{1:L\}}]$
   \STATE {\bfseries Output:} Derivatives $\{\frac{\partial \mathcal{L}_{MSE}}{\partial b_l}\}_{l=1:L}, \{\frac{\partial \mathcal{L}_{MSE}}{\partial W_l}\}_{l=1:L}$
   \STATE
